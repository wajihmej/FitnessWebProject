        ...
        <aside class="right-side right-padding">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="AfficherCoachs.php">Listes Coachs</a>
                    </li>
                </ol>
            </section>
                                ...
                                <table class="table table-bordered text-center" id="fitness-table">
                                    ...
                                    $liste=$coachc->affichercoachs();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="ModifierCoach.php?cin=<?PHP echo $row['cin']; ?>">
