...
header('Location: ParametreAdmin.php?id='.($_GET['id']));
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="ParametreAdmin.php?id=<?PHP echo $_GET['id'] ; ?>" class="activated">Parametre Compte</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i> Parametre Compte
                            </h4>
