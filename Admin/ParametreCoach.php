...
if($_POST['Modifier'])
{
$coach=new Coach($cin,$_POST['nomuser'],$_POST['prenomuser'],$_POST['email'],$_POST['mdp'],$_POST['tel'],$_POST['adresse'],$_POST['sexe'],$_POST['dateannif'],$_POST['categorie']);
    if($_POST['mdp'] != "")
    {
        $coachC->modifierCoachPwd($coach,$_GET['cin']);
    }
    else
    {
        $coachC->modifierCoach($coach,$_GET['cin']);
    ...
    $folder = "./assets/images/coach/".$filename ;
        ...
        $coachC->ajouterCoachimg($_POST['email'],$folder);
         $_SESSION['imagecoach'] = $folder;

        }
         $_SESSION['coach'] = $_POST['nomuser']." ".$_POST['prenomuser'];
         $_SESSION['emailcoach'] = $_POST['email'];
         $_SESSION['telcoach'] = $_POST['tel'];
         $_SESSION['adressecoach'] = $_POST['adresse'];
         $_SESSION['sexecoach'] = $_POST['sexe'];
         $_SESSION['categoriecoach'] = $categorie;

        header('Location: ParametreCoach.php?cin='.($_GET['cin']) );
//*/
}
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <aside class="right-side strech">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="indexCoach.php">
                            <i class="fa fa-fw fa-home"></i> Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="ModifierAdmin.php?id=<?PHP echo $_GET['id'] ; ?>" class="activated">Parametre Compte</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="prenomuser" placeholder="Prenom" name="prenomuser" value="<?PHP echo $prenom ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Adresse" id="adresse" class="form-control" name="adresse" value="<?PHP echo $adresse ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class="form-control" name="sexe" id="sexe">
                                                            <option value="<?PHP echo $sexe ?>">Selectionner sexe</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class='input-group date datetimepicker4'>
                                                            <input type='date' class="form-control" id="dateannif" name="dateannif" value="<?PHP echo $date_nais ?>" />
                                                            <span class="input-group-addon">
                                                            </span>
                                                        </div>
                                                    </div>
