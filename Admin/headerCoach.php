        <nav class="navbar navbar-static-top">
            <a href="indexCoach.php" class="logo">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                            <img src="<?php echo $_SESSION['imagecoach']; ?>" width="35" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                            <div class="riot">
                                <div>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?php echo $_SESSION['imagecoach']; ?>" class="img-circle" alt="User Image">
                                <p><?php echo $_SESSION['coach']; ?></p>
                            </li>
                            <!-- Menu Body -->
                            <li class="pad-3">
                                <a href="ProfilCoach.php">
                                    <i class="fa fa-fw fa-user"></i> Mon Profile
                                </a>
                            </li>
                            <li role="presentation"></li>
                            <li>
                                <a href="ParametreCoach.php?cin=<?PHP echo $_SESSION['cin']; ?>">
                                    <i class="fa fa-fw fa-gear"></i> Parametre Compte
                                </a>
                            </li>
                            <li role="presentation" class="divider"></li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                    <a href="DeconnexionCoach.php">
                                        <i class="fa fa-fw fa-sign-out"></i> Se deconnecté
                                    </a>
                            </li>
                        </ul>
                    </li>
